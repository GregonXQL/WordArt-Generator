...
model = InceptionV3(input_tensor=input_tensor, weights='imagenet', include_top=False, pooling='max')
model.summary()
'''
...
feature_layers = ['conv2d_11', 'conv2d_31', 'conv2d_61']
...
for i in range(len(feature_layers)):
    ...
    loss = loss + w * style_loss(style_reference_features_mix, combination_features)
